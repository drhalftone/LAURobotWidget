...
void LAUZeroConfClientWidget::onServiceError(QZeroConf::error_t error)
{
    switch (error) {
        ...
        case QZeroConf::serviceRegistrationFailed:
            QMessageBox::warning(NULL, QString("LAUZeroConfClientWidget"), QString("Zero Conf Server Error: Registration failed!"), QMessageBox::Ok);
            break;
        case QZeroConf::serviceNameCollision:
            QMessageBox::warning(NULL, QString("LAUZeroConfClientWidget"), QString("Zero Conf Server Error: Name collision!"), QMessageBox::Ok);
            break;
        case QZeroConf::browserFailed:
            QMessageBox::warning(NULL, QString("LAUZeroConfClientWidget"), QString("Zero Conf Server Error: Browser failed!"), QMessageBox::Ok);
            break;
    }
}
